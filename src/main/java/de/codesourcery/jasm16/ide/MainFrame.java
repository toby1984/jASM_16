...
public class MainFrame extends JFrame
{
    ...
    private final SourceEditorView sourceEditorView;
    ...
    public MainFrame(IWorkspace workspace) 
    {
        ...
        this.sourceEditorView = new SourceEditorView(this,workspace);
        setup();
    }
    ...
    public IAssemblerProject getCurrentProject() {
